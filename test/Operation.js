...
tap.test('validate', t => {
    t.test('basic', t => {
        ...
        t.type(validate({ 0: 0, 1: 1, length: 2 }), Error, 'not an array: an object pretending to be a "delete" action')
        t.type(validate(['0', 5]), Error, 'invalid action')
        t.type(validate([-1, 5]), Error, 'unsupported action')
        t.type(validate([ 0 ]), Error, 'too short for delete')
        t.type(validate([ 1 ]), Error, 'too short for retain')
        t.type(validate([ 2, 'a', 0 ]), Error, 'too short for insert text')
        t.type(validate([ 3, 'a', 0, '' ]), Error, 'too short for insert open')
        t.type(validate([ 4, 'a', 0, '' ]), Error, 'too short for insert close')
        t.type(validate([ 5, 'a', 0, '' ]), Error, 'too short for insert embed')
        t.end()
    })
    ...
    t.test('insertOpen', t => {
        ...
        t.type(validate(createInsertOpen('a', -1, '', '')), Error, 'version negative')
        t.type(validate(createInsertOpen('a', 1.01, '', '')), Error, 'version not int')
        t.type(validate(createInsertOpen('a', Infinity, '', '')), Error, 'version not finite')
        t.type(validate(createInsertOpen('a', '1', '', '')), Error, 'version not a number')
        t.type(validate(createInsertOpen('a', 0, 1, '')), Error, 'author not a string')
        t.type(validate(createInsertOpen('a', 0, '', 1)), Error, 'nodeName not a string')
        t.type(validate(createInsertOpen('a', 0, '', '', [ '1' ])), Error, 'no attribute value')
        t.type(validate(createInsertOpen('a', 0, '', '', [ 1, '1' ])), Error, 'attribute name not a string')
        t.type(validate(createInsertOpen('a', 0, '', '', [ null, '1' ])), Error, 'attribute name not a string')
        t.type(validate(createInsertOpen('a', 0, '', '', [ '1', 1 ])), Error, 'attribute value not a string')
        t.type(validate(createInsertOpen('a', 0, '', '', [ '1', null ])), Error, 'attribute value not a string')
        t.type(validate(createInsertOpen('a', 0, '', '', [ 'b', '', 'a', '' ])), Error, 'attributes not sorted by name')
        t.type(validate(createInsertOpen('a', 0, '', '', [ 'a', '', 'a', '' ])), Error, 'duplicate attribute name')
        t.type(validate(createInsertOpen('a', 0, '', '', [ 'a', '', 'b', '', 'a', '' ])), Error, 'attributes not sorted by name')
        t.equal(validate(createInsertOpen('a', 0, '', '')), null)
        t.equal(validate(createInsertOpen('a', 0, '', 'DIV')), null)
        t.equal(validate(createInsertOpen('a', 0, '', '', [ '1', '1' ])), null)
        t.equal(validate(createInsertOpen('a', 0, '', '', [ '1', '' ])), null)
        t.equal(validate(createInsertOpen('a', 0, '', '', [ '', '', '1', '', 'a', '', 'ab', 'b' ])), null)
        t.equal(validate(createInsertOpen('a', 0, '', '', [ 'a', '', 'b', '' ])), null)
        t.end()
    })
    ...
    t.test('insertClose', t => {
        ...
        t.type(validate(createInsertClose('a', -1, '', '')), Error, 'version negative')
        t.type(validate(createInsertClose('a', 1.01, '', '')), Error, 'version not int')
        t.type(validate(createInsertClose('a', Infinity, '', '')), Error, 'version not finite')
        t.type(validate(createInsertClose('a', '1', '', '')), Error, 'version not a number')
        t.type(validate(createInsertClose('a', 0, 1, '')), Error, 'author not a string')
        t.type(validate(createInsertClose('a', 0, '', 1)), Error, 'nodeName not a string')
        t.type(validate(createInsertClose('a', 0, '', '', [ '1' ])), Error, 'no attribute value')
        t.type(validate(createInsertClose('a', 0, '', '', [ 1, '1' ])), Error, 'attribute name not a string')
        t.type(validate(createInsertClose('a', 0, '', '', [ null, '1' ])), Error, 'attribute name not a string')
        t.type(validate(createInsertClose('a', 0, '', '', [ '1', 1 ])), Error, 'attribute value not a string')
        t.type(validate(createInsertClose('a', 0, '', '', [ '1', null ])), Error, 'attribute value not a string')
        t.type(validate(createInsertClose('a', 0, '', '', [ 'b', '', 'a', '' ])), Error, 'attributes not sorted by name')
        t.type(validate(createInsertClose('a', 0, '', '', [ 'a', '', 'a', '' ])), Error, 'duplicate attribute name')
        t.type(validate(createInsertClose('a', 0, '', '', [ 'a', '', 'b', '', 'a', '' ])), Error, 'attributes not sorted by name')
        t.equal(validate(createInsertClose('a', 0, '', '')), null)
        t.equal(validate(createInsertClose('a', 0, '', 'DIV')), null)
        t.equal(validate(createInsertClose('a', 0, '', '', [ '1', '1' ])), null)
        t.equal(validate(createInsertClose('a', 0, '', '', [ '1', '' ])), null)
        t.equal(validate(createInsertClose('a', 0, '', '', [ '', '', '1', '', 'a', '', 'ab', 'b' ])), null)
        t.equal(validate(createInsertClose('a', 0, '', '', [ 'a', '', 'b', '' ])), null)
        t.end()
    })
    ...
    t.test('insertEmbed', t => {
        ...
        t.type(validate(createInsertEmbed('a', -1, '', '')), Error, 'version negative')
        t.type(validate(createInsertEmbed('a', 1.01, '', '')), Error, 'version not int')
        t.type(validate(createInsertEmbed('a', Infinity, '', '')), Error, 'version not finite')
        t.type(validate(createInsertEmbed('a', '1', '', '')), Error, 'version not a number')
        t.type(validate(createInsertEmbed('a', 0, 1, '')), Error, 'author not a string')
        t.type(validate(createInsertEmbed('a', 0, '', 1)), Error, 'nodeName not a string')
        t.type(validate(createInsertEmbed('a', 0, '', '', [ '1' ])), Error, 'no attribute value')
        t.type(validate(createInsertEmbed('a', 0, '', '', [ 1, '1' ])), Error, 'attribute name not a string')
        t.type(validate(createInsertEmbed('a', 0, '', '', [ null, '1' ])), Error, 'attribute name not a string')
        t.type(validate(createInsertEmbed('a', 0, '', '', [ '1', 1 ])), Error, 'attribute value not a string')
        t.type(validate(createInsertEmbed('a', 0, '', '', [ '1', null ])), Error, 'attribute value not a string')
        t.type(validate(createInsertEmbed('a', 0, '', '', [ 'b', '', 'a', '' ])), Error, 'attributes not sorted by name')
        t.type(validate(createInsertEmbed('a', 0, '', '', [ 'a', '', 'a', '' ])), Error, 'duplicate attribute name')
        t.type(validate(createInsertEmbed('a', 0, '', '', [ 'a', '', 'b', '', 'a', '' ])), Error, 'attributes not sorted by name')
        t.equal(validate(createInsertEmbed('a', 0, '', '')), null)
        t.equal(validate(createInsertEmbed('a', 0, '', 'DIV')), null)
        t.equal(validate(createInsertEmbed('a', 0, '', '', [ '1', '1' ])), null)
        t.equal(validate(createInsertEmbed('a', 0, '', '', [ '1', '' ])), null)
        t.equal(validate(createInsertEmbed('a', 0, '', '', [ '', '', '1', '', 'a', '', 'ab', 'b' ])), null)
        t.equal(validate(createInsertEmbed('a', 0, '', '', [ 'a', '', 'b', '' ])), null)
        t.end()
    })
