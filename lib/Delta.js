...
const {
    ...
    getLength, hasAttributes, getContent, areOperationsEqual,
...
function diffX(delta1, delta2) {
    ...
    while (startIndex1 <= endIndex1) {
        ...
        differingContent1 += isInsertText(operation1) ? getContent(operation1) : '\0'
    }
    ...
    while (startIndex2 <= endIndex2) {
        ...
        differingContent2 += isInsertText(operation2) ? getContent(operation2) : '\0'
    }
