...
const transformIterators = (iterator1, iterator2, operation1First) => {
    const operation1 = iterator1.operation
    const operation2 = iterator2.operation
    ...
    if (isInsert(operation2) && (!operation1First || !isInsert(operation1))) {
    ...
    if (isDelete(operation2)) {
        ...
        return transformIterators(iterator1, iterator2, operation1First)
    }

    if (isDelete(operation1)) {
        return createDelete(length)
    }
}
