...
const createInsertText = (content, attributes) => appendAttributes([ ACTION_INSERT_TEXT, content || '' ], attributes)
const createInsertOpen = (content, attributes) => appendAttributes([ ACTION_INSERT_OPEN, content || '' ], attributes)
const createInsertClose = (content, attributes) => appendAttributes([ ACTION_INSERT_CLOSE, content || '' ], attributes)
const createInsertEmbed = (content, attributes) => appendAttributes([ ACTION_INSERT_EMBED, content || '' ], attributes)
const createRetain = (content, attributes) => appendAttributes([ ACTION_RETAIN, content > 0 ? content : 0 ], attributes)
