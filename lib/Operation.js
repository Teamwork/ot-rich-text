    ...
    while (diffLength > 0) {
        ...
        switch (diffType) {
            case 1: // `diffContent` present only in iterator2
                ...
                offset2 = iterator2.offset
                remaining2 = iterator2.remaining
                length = diffLength < remaining2 ? diffLength : remaining2
            ...
            case -1: // `diffContent` present only in iterator1
                ...
                offset1 = iterator1.offset
                remaining1 = iterator1.remaining
                length = diffLength < remaining1 ? diffLength : remaining1
            ...
            case 0: // `diffContent` present in both iterator1 and iterator2
                ...
                if (operation1[ACTION] === operation2[ACTION] &&
                    ...
                    const retain = createRetain(length)

                    callback(retain, retain)

                    // TODO diff attributes

                } else {
                    const del = createDelete(length)
