...
const createInsertText = (content = '', version = 0, author = '') => [ ACTION_INSERT | ACTION_INSERT_TEXT, content, version, author ]
const createInsertOpen = (content = '', version = 0, author = '') => [ ACTION_INSERT | ACTION_INSERT_OPEN, content, version, author ]
const createInsertClose = (content = '', version = 0, author = '') => [ ACTION_INSERT | ACTION_INSERT_CLOSE, content, version, author ]
const createInsertEmbed = (content = '', version = 0, author = '') => [ ACTION_INSERT | ACTION_INSERT_EMBED, content, version, author ]
const createRetain = (content = 0, version = 0, author = '') => [ ACTION_RETAIN, content, version, author ]
const createDelete = (content = 0, version = 0, author = '') => [ ACTION_DELETE, content, version, author ]

const getAction = (operation) => operation[ACTION]
    ...
    switch (action & ACTION_MASK) {
        case ACTION_INSERT:
            if ((action & INSERT_TYPE_MASK) === ACTION_INSERT_TEXT) {
                ...
                return operation[CONTENT].length > 1 | 0
            }
        case ACTION_RETAIN:
        case ACTION_DELETE:
...
const areEqual = (operation1, operation2) => {
